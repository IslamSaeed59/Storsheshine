...
export const createMainPage = (mainPageData) =>
  apiClient.post("/mainpage", mainPageData);
export const updateMainPage = (mainPageData) =>
  apiClient.put("/mainpage", mainPageData);
